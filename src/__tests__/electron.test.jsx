...
async function assumeRole(credentials, roleArn, sessionName = 'SidewalkQAFriends') {
  if (!roleArn) {
...
// 3p
{
  ...
  describe('Parameter Substitution - Data Type Preservation', () => {
    ...
    it('should handle nested JSON objects with numeric substitution', () => {
      ...
      expect(parsedBody.TransmitMode).toBe(0); // Should remain as number
      expect(parsedBody.WirelessMetadata.Sidewalk.Seq).toBe('12'); // Template variables remain as strings
      expect(parsedBody.PayloadData).toBe('SGVsbG8='); // Should remain as string
  ...
  describe('AWS STS Role Assumption', () => {
    ...
    it('should handle role assumption for different environments', async () => {
      ...
      const hyperionGammaRoleArn = 'arn:aws:iam::989407843865:role/sidewalk_operations_lambda_access_role';
      const hyperionProdRoleArn = 'arn:aws:iam::059456100934:role/sidewalk_operations_lambda_access_role';
      ...
      const environments = [
        {
          ...
          roleArn: 'arn:aws:iam::989407843865:role/sidewalk_operations_lambda_access_role',
        ...
        },
        {
          ...
          roleArn: 'arn:aws:iam::059456100934:role/sidewalk_operations_lambda_access_role',
          supportedApis: ['resetDataUsage', 'setMaxDataUsage']
        }
      ];
