...
describe('testgen kind redaction', () => {
  it('openapi source is host-stripped when sent', async () => {
    ...
    await qaAiSend({ site: 'testgen', kind: 'testgen', payload: { source: 'openapi', input: JSON.stringify({ servers: [{ url: 'https://prod.acme.com' }], paths: {} }) } }, { callLLM, approve: () => Promise.resolve(true) });
