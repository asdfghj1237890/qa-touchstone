...
describe('FilesPage', () => {
  ...
  describe('Device Type Change', () => {
    ...
    it('updates destination paths based on device type', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByDisplayValue('/vendor/etc/halo_config/core-plugins/qa-touchstone.conf.d')).toBeInTheDocument();
      });
      ...
      await waitFor(() => {
        expect(screen.getByDisplayValue('/etc/halo_config/core-plugins/qa-touchstone.conf.d')).toBeInTheDocument();
      });
    });
  });
  ...
  describe('ADB Operations', () => {
    ...
    it('tests ADB push functionality with complete flow', async () => {
      ...
      await waitFor(() => {
        ...
        const pushDestInput = screen.getByDisplayValue('/vendor/etc/halo_config/core-plugins/qa-touchstone.conf.d');
