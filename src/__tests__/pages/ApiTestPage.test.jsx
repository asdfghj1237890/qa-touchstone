...
describe('ApiTestPage', () => {
  ...
  it('shows environment and authentication options', async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.queryByText(/qa-touchstone Operations/i)).not.toBeInTheDocument();
  ...
  describe('AWS STS Role Assumption', () => {
    ...
    it('should handle role assumption failure gracefully', async () => {
      ...
      mockElectronAPI.executePostmanRequest.mockImplementation(() => 
        Promise.resolve({
          success: false,
          error: 'Failed to assume role arn:aws:iam::989407843865:role/qa-touchstone_operations_lambda_access_role: Access denied'
        })
      );
