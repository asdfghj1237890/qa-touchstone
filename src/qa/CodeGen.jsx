...
// ── QA Companion — code snippet generator (cURL / Python / JS / HTTPie) ────
...
function qShell(s) { return `'${String(s).replace(/'/g, `'\\''`)}'`; }
function qPy(s) { return `"${String(s).replace(/\\/g, '\\\\').replace(/"/g, '\\"')}"`; }
