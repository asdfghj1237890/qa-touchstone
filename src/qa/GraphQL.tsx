...
interface GqlField { name: string; args?: string; type?: string }
interface GqlSchemaType { name: string; kind: string; fields: GqlField[] }
interface GqlSchema { endpoint?: string; types: GqlSchemaType[] }
