...
export const AI_POLICY_DENY = Object.freeze({ externalAllowed: false, forcedMode: 'local', locked: true });

let _cached = null;
let _loading = null;
export function getCachedAiPolicy() { return _cached; }
export function setCachedAiPolicy(p) { _cached = p; _loading = null; }
...
export async function ensureAiPolicy(apiMod) {
