...
const res = await build({
  entryPoints: [join(__dir, '..', 'src', 'qa', 'oracles.ts')],
  bundle: true,
  format: 'esm',
  write: false,
  platform: 'node',
...
const tmp = join(tmpDir, 'oracles.mjs');
...
if (typeof mod.scanSensitive !== 'function')
  throw new Error('scanSensitive not exported from oracles.ts bundle');
